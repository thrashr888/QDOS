...
impl Plugin for JjPlugin {
    ...
    fn help_content(&self) -> Vec<String> {
        vec![
            ...
            "  Status: View working copy status".to_string(),
            "  Log: View revision history".to_string(),
            "  Diff: Show changes".to_string(),
            "  Describe: Update change description".to_string(),
            "  New: Create a new change".to_string(),
            "  Bookmark: Manage bookmarks".to_string(),
            "  Operations: View/undo operations".to_string(),
            "  Git: Push/fetch from remotes".to_string(),
        ]
    }
