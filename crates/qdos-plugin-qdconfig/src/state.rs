...
use qdos_plugin_api::{ColorTheme, SortMode};
...
impl QdconfigState {
    ...
    // TODO: Implement reload_from_config when config types are shared
    // This requires a shared config crate or trait-based config access
}
